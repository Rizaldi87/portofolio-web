  ...
  return (
    ...
    >
      ...
      <div
        ...
        `}
      >
        <a href="#about" className="text-[#6b6b88] hover:text-[#e8e8f0]">
          About Me
        </a>
        <a href="#project" className="text-[#6b6b88] hover:text-[#e8e8f0]">
          Projects
        </a>
        <a href="#experience" className="text-[#6b6b88] hover:text-[#e8e8f0]">
          Experiences
        </a>
        <a href="#contact" className="text-[#6b6b88] hover:text-[#e8e8f0]">
          Contact
        </a>
      </div>
    </div>
